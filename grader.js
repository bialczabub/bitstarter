...
var assertUrlExists = function(url){return url.toString();}
...
if(require.main == module) {
	...
	.option ('-u, --url <url>', 'URL of html to be graded', clone(assertUrlExists)) /*, URL_DEFAULT)*/
	.parse(process.argv);
    //var htmlFile = program.url || program.file   
    if (program.url) {
	//console.log("in this loop with url: "+program.url); 
